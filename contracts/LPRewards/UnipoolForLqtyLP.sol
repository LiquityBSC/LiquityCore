 ...
 */
contract UnipoolForLqtyLP is LPTokenWrapper, Ownable, CheckContract {
    string constant public NAME = "UnipoolForLQTY";
    ...
    modifier onlyMultisigAddress() {
        require (msg.sender == multisigAddress, "UnipoolForLqtyLP: not multisigAddress");
        _;
    }
