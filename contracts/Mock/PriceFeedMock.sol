...
* Chainlink oracle.
*/
contract PriceFeedMock is Ownable, CheckContract, BaseMath, IPriceFeed {
    ...
    */
    ...
    function _getCurrentBandResponse() internal view returns (IStdReference.ReferenceData memory bandResponse){
        return bandCaller.getReferenceData("BNB", "USD");
    }
